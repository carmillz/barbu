...
public class Jeu {
    ...
    public void tourReussite(){
        for (int i = 0; i<joueurs.size(); i++){
            Carte carte = joueurs.get(i).choisirCarteReussite(this);
    ...
    public int tour() {
        for (int j = 0; j < joueurs.size(); j++) {
            ...
            joueurs.get(j).choisirCarte(this, (Collection<Carte>) plateau);
        }
