...
public class Carte {
	...
	public Carte(String symbole, int valeur) {
		 ...
		 * est calculÃƒÂ©e ÃƒÂ  partir du nom via une mÃƒÂ©thode annexe
		 */
		super();
		this.symbole = symbole;
		this.valeur = valeur;
	...
	/*
	 * La mÃƒÂ©thode valeurToNom permet, ÃƒÂ  partir de la valeur qui est passÃƒÂ©e en paramÃƒÂ¨tre
	 * de donner un nom ÃƒÂ  la carte pour simplifier la comprÃƒÂ©hension, notamment du
	 * valet ÃƒÂ  l'as.
	 */
