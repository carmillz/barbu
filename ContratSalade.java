...
public class ContratSalade implements Contrat {
    ...
    public void comptePoints(ArrayList<Joueur> joueurs) {
        ...
        for (int i = 0; i <= joueurs.size(); i++) {
            ...
            joueur.getPoints().add(cptcoeur*10 + cptdame*20 + cptroi + cptpli); //Vérifier les points dans tous les contrats et celui-ci !!
        }
    ...
    public boolean fin(Jeu jeu, int nombre) {
        // Si le nombre de carte en jeu est égal à 0 (donc plus de carte à jouer) 
        // Alors la partie est finie donc : True
        // Sinon la partie continue donc: False
        return jeu.nbcartesencours == 0;            
    }
