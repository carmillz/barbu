...
public class Paquet {
	 ...
	 * pour pouvoir créer le "bon nombre" de cartes et le paquet de carte qui est un
	 * HashSet de cartes afin de faciliter la distribution au hasard entre les
	 * joueurs
	 */
	...
	/*
	 * La méthode creationPaquet(int nbCartes) permet de créer un paquet de nbCarte
	 * cartes sachant que suivant le nombre de cartes, on "commence" à une carte
	 * différente : 2 pour 52 cartes, 7 pour 32... Au niveau de l'éxecution, on crée
	 * les cartes pour chaque symbole et on les ajoute à un HashSet qui nous
	 * permettera de les tirer au hasard au moment de la distribution
	 */
	...
	/*
	 * la méthode distribuer(ArrayList<Joueur> joueurs) permet, suivant le nombre de
	 * joueurs sachant que le joueur qui "distribue" est le dernier de la liste. Au
	 * niveau de l'exécution de la méthode, on vide au fur et à mesure le paquet de
	 * cartes en ajoutant une carte choisie au hasard avec un itérateur à la main du
